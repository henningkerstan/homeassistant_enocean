...
class DeviceType:
    ...
    def label(self) -> str:
        ...
        if self.unique_id == self.eep:
            return "EEP " + self.eep + " (" + self.model + ")"
        return self.manufacturer + " " + self.model + " (EEP " + self.eep + ")"
    


    @classmethod
    def get_supported_device_types(cls) -> dict[str, "DeviceType"]:
