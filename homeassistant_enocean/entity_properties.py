class HomeAssistantEntityProperties:
    ...
    def __init__(self, unique_id: str | None = None, device_class: str | None = None, supported_features: int | None = None, translation_key: str | None = None, event_types: list[str] | None = None) -> None:
